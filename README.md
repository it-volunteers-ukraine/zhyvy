## Website for Public Non-Profit Organization "Zhyvy" ("Live")

## Сайт для Громадської Організації "ЖИВИ"

Bолонтерський проєкт команди IT-Volunteers


![Zhyvy](screenshot.png)
