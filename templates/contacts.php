    ...
    <section class="container">
        <div class="content">
            ...
            <div class="contacts-middle">
                ...
                <?php if ( get_field( 'site', 'option' ) ) { ?>
                <a href="<?php the_field( 'site', 'option' ); ?>" target="_blank" aria-label="Перейти на сайт-візитку">
                    <span class="icon">
                        <svg width="32" height="32">
                            <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-site">
                            </use>
                        </svg>
                    </span>
                ...
                <a href="<?php the_field( 'viber', 'option' ); ?>" target="_blank"
                    ...
                    <span class="icon">
                        <svg width="32" height="32">
                            <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-viber">
                            </use>
                        </svg>
                    </span>
            ...
            <div class="contacts-bottom">
                ...
                <a href="<?php the_field( 'twitter', 'option' ); ?>" target="_blank"
                    ...
                    <span class="icon">
                        <svg width="32" height="32">
                            <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-twitter">
                            </use>
                        </svg>
                    </span>
                </a>
                ...
                <a href="<?php the_field( 'youtube', 'option' ); ?>" target="_blank"
                    ...
                    <span class="icon">
                        <svg width="32" height="32">
                            <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-youtube">
                            </use>
                        </svg>
                    </span>
                </a>
                ...
                <a href="<?php the_field( 'tiktok', 'option' ); ?>" target="_blank"
                    ...
                    <span class="icon">
                        <svg width="32" height="32">
                            <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-tik_tok">
                            </use>
                        </svg>
                    </span>
                </a>
