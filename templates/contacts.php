    ...
    <main>
        ...
        <section class="container">
            <div class="content">
                    ...
                    <div class="contacts-bottom">
						<?php if ( get_field( 'twitter', 'option' ) ) { ?>
                            <a href="<?php the_field( 'twitter', 'option' ); ?>"
                               target="_blank" aria-label="Перейти на сторінку в Твіттер">
                                <span class="icon">
                                    <svg width="32" height="32">
                                    <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-twitter"></use>
                                    </svg>
                                </span>
                            </a>
						<?php } ?>
						...
						<?php if ( get_field( 'youtube', 'option' ) ) { ?>
                            <a href="<?php the_field( 'youtube', 'option' ); ?>"
                               target="_blank" aria-label="Перейти на сторінку в Ютуб">
                                <span class="icon">
                                    <svg width="32" height="32">
                                    <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-youtube"></use>
                                    </svg>
                                </span>
                            </a>
						<?php } ?>
						...
						<?php if ( get_field( 'instagram', 'option' ) ) { ?>
                            <a href="<?php the_field( 'instagram', 'option' ); ?>"
                               target="_blank" aria-label="Перейти на сторінку в Інстаграм">
                                <span class="icon">
                                    <svg width="32" height="32">
                                    <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-instagram"></use>
                                    </svg>
                                </span>
                            </a>
						<?php } ?>
						...
						<?php if ( get_field( 'telegram', 'option' ) ) { ?>
                            <a href="<?php the_field( 'telegram', 'option' ); ?>"
                               target="_blank" aria-label="Перейти на групу в Телеграм">
                                <span class="icon">
                                    <svg width="32" height="32">
                                    <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-telegram"></use>
                                    </svg>
                                </span>
                            </a>
						<?php } ?>
						...
						<?php if ( get_field( 'tiktok', 'option' ) ) { ?>
                            <a href="<?php the_field( 'tiktok', 'option' ); ?>"
                               target="_blank" aria-label="Перейти на сторінку в Тікток">
                                <span class="icon">
                                    <svg width="32" height="32">
                                    <use href="<?php bloginfo( 'template_url' ); ?>/assets/images/sprite.svg#colorIcon-tik_tok"></use>
                                    </svg>
                                </span>
                            </a>
						<?php } ?>
                ...
                <!--  Map  -->
                <div class="map">
                    <iframe src="<?php the_field( 'google_map_embed', 'option' ); ?>"
